...
public class Terminal extends Parser {
	 ...
	 * this terminal against all of them, and returns a new collection
	 * of the assemblies that result form the matches.
	 * 
	 ...
	 * front of the assembly. As with any parser, if the match
	 * succeeds, this terminal's assembler will work on the assembly.
	 * If the match fails, this method returns null.
	 * 
